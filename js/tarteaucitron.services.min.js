...
tarteaucitron.services.antvoice = {
    ...
    js: function() {
        ...
        window.avtag = window.avtag || function(_cmd, _p) {
            window.avDataLayer.push({
                cmd: _cmd,
                p: _p
            })
        };
        window.avtag("setConsent", {
            consent: true
        });
        window.avtag("init", {
            id: tarteaucitron.user.antvoiceId
        });
...
tarteaucitron.services.userpilot = {
    ...
    js: function() {
        ...
        window.userpilotSettings = {
            token: tarteaucitron.user.userpilotToken
        };
    ...
    js: function() {
        ...
        tarteaucitron.fallback(["artetv_player"], function(x) {
            var frame_title = tarteaucitron.getElemAttr(x, "title") || "Arte.tv iframe",
                ...
                video_frame, video_allowfullscreen = tarteaucitron.getElemAttr(x, "allowfullscreen");
    ...
    js: function() {
        ...
        tarteaucitron.fallback(["dailymotion_player"], function(x) {
            var frame_title = tarteaucitron.getElemAttr(x, "title") || "Dailymotion iframe",
                ...
                video_height = tarteaucitron.getElemAttr(x, "height"),
                frame_height = "height=",
                video_frame, embed_type = tarteaucitron.getElemAttr(x, "embedType"),
                allowfullscreen = tarteaucitron.getElemAttr(x, "allowfullscreen"),
    ...
    js: function() {
        ...
        tarteaucitron.fallback(["deezer_player"], function(x) {
            var frame_title = tarteaucitron.getElemAttr(x, "title") || "Deezer iframe",
                ...
                frame_height = "height=",
                deezer_frame, embed_theme = tarteaucitron.getElemAttr(x, "theme"),
    ...
    js: function() {
        ...
        tarteaucitron.fallback(["instagram_post"], function(x) {
            var frame_title = tarteaucitron.getElemAttr(x, "title") || "Instagram iframe",
                ...
                frame_width, frame_height, post_frame;
    ...
    js: function() {
        ...
        tarteaucitron.fallback(["youtube_player"], function(x) {
            var frame_title = tarteaucitron.getElemAttr(x, "title") || "Youtube iframe",
                ...
                video_height = tarteaucitron.getElemAttr(x, "height"),
                frame_height = "height=",
                video_frame, allowfullscreen = tarteaucitron.getElemAttr(x, "allowfullscreen"),
...
tarteaucitron.services.affilae = {
    ...
    js: function() {
        ...
        window._ae = {
            pid: tarteaucitron.user.affilae
        };
...
tarteaucitron.services.canalu = {
    ...
    js: function() {
        ...
        tarteaucitron.fallback(["canalu_player"], function(x) {
            ...
            return '<div style="position:relative;padding-bottom:56.25%;padding-top:10px;height:0;overflow:hidden;">' + '<iframe src="' + frame_url + '?width=100%&amp;height=100%" ' + 'style="position:absolute;top:0;left:0;width:100%;height: 100%;" ' + 'frameborder="0" ' + "allowfullscreen " + 'scrolling="no">' + "</iframe>" + "</div>"
        })
    },
    fallback: function() {
        "use strict";
