...
export function stampaSchedaRicetta(datiRicetta) {
    ...
    if (!datiRicetta) {
        alert(isEn ? 'Please calculate a recipe first before printing.' : 'Calcola prima una ricetta per poterla stampare.');
        return;
    }
    ...
    const html = `
        ...
        <body>
            ...
            <div class="footer">
                ${isEn ? 'Generated by PizzaLab — The digital laboratory for the perfect pizza (https://pizzalab.pizza)' : 'Generato da PizzaLab — Il laboratorio digitale della pizza perfetta (https://pizzalab.pizza)'}
            </div>
