...
import { inizializzaStrumenti, aggiornaStrumentiPerLingua } from './tools-page.js';
...
// Gli strumenti accessori vivono in tools-page.js: qui si limitano a essere
// avviati e ridisegnati al cambio lingua.
inizializzaStrumenti();

// Aggiorna dinamicamente al cambio lingua
window.addEventListener('pizzalab:locale-changed', () => {
    aggiornaStrumentiPerLingua();
    aggiornaSuggerimentoW();
