...
function calcolaRicettaFissa(tipoPizza, metodo, numPanetti) {
    ...
    // Parametri di default per i metodi diversi da diretto (modificali come desideri)
    const percentualeBiga = 70;
    const percentualePoolish = 50;
    const percentualePastaMadre = 20;
...
// Di seguito le funzioni parametriche per ciascun metodo.
// Puoi personalizzare i parametri fissi se necessario.

// Diretto già definito in calcolatore_script.js, ma lo rifacciamo param.
